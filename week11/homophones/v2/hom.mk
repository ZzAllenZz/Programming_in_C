...
run: $(TESTBASE)
	./$(TESTBASE) -n 4 CHRISTMAS PROGRAM PASSING RHYME BOY DOLLARS KILMARNOCK GODDESS EQUALIZER
...
memleaks: $(TESTBASE)_d $(TESTBASE)_s
	@echo "Sanitize :"
	@./$(TESTBASE)_s - n 4 CHRISTMAS PROGRAM PASSING RHYME BOY DOLLARS KILMARNOCK GODDESS EQUALIZER
	@echo "Valgrind :"
	@valgrind --leak-check=full ./$(TESTBASE)_d -n 4 CHRISTMAS PROGRAM PASSING RHYME BOY DOLLARS KILMARNOCK GODDESS EQUALIZER
