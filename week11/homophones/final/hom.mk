...
run: $(TESTBASE)
	./$(TESTBASE) CHRISTMAS PROGRAM PASSING RHYME BOY DOLLARS KILMARNOCK GODDESS EQUALIZER
...
memleaks: $(TESTBASE)_d $(TESTBASE)_s
	@echo "Sanitize :"
	@./$(TESTBASE)_s CHRISTMAS PROGRAM PASSING RHYME BOY DOLLARS KILMARNOCK GODDESS EQUALIZER
	@echo "Valgrind :"
	@valgrind --leak-check=full ./$(TESTBASE)_d CHRISTMAS PROGRAM PASSING RHYME BOY DOLLARS KILMARNOCK GODDESS EQUALIZER
